...
class Institute(Base):
    ...
    agreement_document_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    agreement_document_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    payment_proof_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    payment_proof_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    ...
    # The only AI ceiling for an institute's students. NULL/0 falls back to the
