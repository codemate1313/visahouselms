...
def upgrade() -> None:
    ...
    if TESTIMONIALS_TABLE not in present:
        op.create_table(
            ...
            sa.Column("student_role", sa.String(length=255), nullable=True, server_default="Academic Language CERT Student"),
    ...
    if BLOG_POSTS_TABLE not in present:
        op.create_table(
            ...
            sa.Column("category", sa.String(length=100), nullable=False, server_default="Language CERT Tips"),
            sa.Column("tags", sa.String(length=255), nullable=True, server_default="Language CERT, Preparation, Speaking, Writing"),
            sa.Column("author_name", sa.String(length=100), nullable=False, server_default="Language CERT Editorial Team"),
