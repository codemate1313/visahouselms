...
export const MODULE_TYPE_META: Record<ExamModuleType, ModuleMeta> = {
  ...
  reading: {
    ...
    durationPresets: [20, 30, 40, 60],
    sampleInstructions: "You have 40 minutes to answer 30 questions across Reading Parts 1A, 1B, 2, 3, and 4.",
  },
  writing: {
    icon: "edit",
    ...
    durationPresets: [30, 45, 60, 90, 100, 120],
    sampleInstructions: "You have 100 minutes for both tasks. Write 150–200 words for Task 1 and approximately 250 words for Task 2.",
  },
  speaking: {
    icon: "microphone",
