...
export const superAdminBlogFormStrings = {
  ...
  fields: {
    ...
    articleTitlePlaceholder: "e.g. 10 Strategies to Score Band 8.0 in LanguageCert Speaking",
    slug: "URL Slug",
    slugPlaceholder: "languagecert-speaking-band-8-strategies",
    ...
    seoTitleTagPlaceholder: "Article Title | LanguageCert",
    tags: "Tags (Comma separated)",
    tagsPlaceholder: "LanguageCert, Preparation, Speaking",
