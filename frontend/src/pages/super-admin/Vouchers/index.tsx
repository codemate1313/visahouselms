        ...
        <div className="vouchers-grid">
          {types.length === 0 ? (
            <div className="col-span-full p-10 text-center bg-slate-50 dark:bg-slate-800/40 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-700/60 my-4">
              ...
              <p className="text-xs text-slate-500 max-w-sm mx-auto mt-1 mb-4">Create a master voucher type (e.g. Language CERT Academic, PTE) to start uploading codes.</p>
              <Button variant="primary" size="small" onClick={() => openTypeModal()}>
                + Add Voucher Type
              </Button>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", width: "100%" }}>
            <div className="form-field-group">
              <Input
                ...
                placeholder="e.g. Language CERT Academic"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-3.5">
              ...
              <Input
                ...
                placeholder="e.g. Language CERT Academic Standard Exam Voucher"
              />
