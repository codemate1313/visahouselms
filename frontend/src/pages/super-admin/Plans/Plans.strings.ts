...
export const plansStrings = {
  ...
  table: {
    ...
    unmarkPopular: "Remove Popular Badge",
    popularBadge: "Popular",
    popularMarked: "Plan marked as Popular. Any previous popular plan in this catalogue was unmarked.",
    popularUnmarked: "Popular badge removed from plan.",
