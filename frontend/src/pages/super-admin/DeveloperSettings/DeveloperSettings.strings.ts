...
export const developerSettingsStrings = {
  ...
  avatar: {
    ...
    hint: "Speaking modules can show a talking-presenter video reading the prompts (via D-ID). Until an API key and presenter image are set here, Speaking parts fall back to no video — instructors can still author them.",
    providerLabel: "Provider",
    voiceLabel: "Voice",
    voicePlaceholder: "en-GB-SoniaNeural",
    apiKeyLabel: "API key",
    apiKeyPlaceholder: "stored encrypted",
    presenterImageLabel: "Presenter image URL",
    presenterImagePlaceholder: "https://.../presenter.jpg",
    saveLabel: "Save Avatar Settings",
    testLabel: "Test connection",
    saveError: "Failed to save avatar settings.",
    testError: "Avatar provider test failed.",
    savedNotice: "Avatar settings saved.",
    testConnectedNotice: "Connected — credentials are valid.",
    testUnverifiedNotice: "Could not verify the connection.",
  },
  ai: {
